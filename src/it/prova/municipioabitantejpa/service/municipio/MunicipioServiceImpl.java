...
public class MunicipioServiceImpl implements MunicipioService {
	...
	public List<Municipio> cercaTuttiConAlmenoUnAbitanteMinorenne() throws Exception {
		EntityManager entityManager = EntityManagerUtil.getEntityManager();
	...
	public List<Municipio> cercaTuttiIMunicipiCheDescrizioneIniziaCon(String descr) throws Exception {
		...
		try {
			...
			// eseguo quello che realmente devo fare
			return municipioDAO.findAllByDescrizioneIniziaCon(descr);
