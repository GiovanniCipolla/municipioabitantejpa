...
public interface AbitanteService {
	...
	public List<Abitante> cercaTuttiGliAbitantiConCognome(String nome) throws Exception;

	public List<Abitante> cercaTuttiGliAbitantiByCodiceMunicipioIniziaCon(String nome) throws Exception;
}
